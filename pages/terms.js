    ...
    return (
        <div className="mx-auto w-full max-w-4xl p-2">
            ...
            <div className="mx-auto w-full max-w-4xl p-2 text-center">
                    ...
                    <p className="pt-5 pb-5">This privacy policy sets out how <span className="font-bold">Forensic<span className="text-red-500">Drone</span></span> uses and protects any information that you give ForensicDrone when you use this website. <span className="font-bold">Forensic<span className="text-red-500">Drone</span></span> is committed to ensuring that your privacy is protected. Should we ask you to provide certain information by which you can be identified when using this website, then you can be assured that it will only be used in accordance with this privacy statement. <span className="font-bold">Forensic<span className="text-red-500">Drone</span></span> may change this policy from time to time by updating this page. You should check this page from time to time to ensure that you are happy with any changes.</p>
            </div>
                ...
                {({ open }) => (
                    <>
                        ...
                        <Disclosure.Panel className="px-4 pt-4 pb-2 text-black">
                            <p className="pb-5">
                                <span className="font-bold">Forensic<span className="text-red-500">Drone</span></span> employs a rate-by-weight system to calculate shipping costs to your area. 
            ...
            <Disclosure as="div" className="mt-2">
                {({ open }) => (
                    <>
                        ...
                        <Disclosure.Panel className="px-4 pt-4 pb-2 text-black">
                            <p><span className="font-bold">Forensic<span className="text-red-500">Drone</span></span> takes great pride and joy in our highly skilled team. 
                                Our team has over 20 years of experience in building technical and forensic systems. 
                                We have proven our excellent contribution and knowledge to designing forensic hardware, software, and infrastructure.
                            </p>
                        </Disclosure.Panel>
                    </>
                )}
